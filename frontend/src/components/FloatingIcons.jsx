...
const FloatingIcons = () => {
  return (
    <motion.div className="hidden xl:flex justify-between items-center">
      <div className="">
        <motion.img
          className="w-20 top-[2rem] opacity-70  left-[11rem] absolute cursor-pointer z-50"
          drag={true}
          dragConstraints={{
            top: -10,
            left: -10,
        ...
        />
        <motion.img
          className="w-20 opacity-70 cursor-pointer top-[20rem] left-[8rem] absolute z-50"
          drag={true}
          dragConstraints={{
            top: -10,
            left: -10,
        ...
        />
        <motion.img
          className="w-20 opacity-70 cursor-pointer top-[35rem] left-[18rem] absolute z-50"
          drag={true}
          dragConstraints={{
            top: -10,
            left: -10,
        ...
        />
        <motion.img
          className="w-20 opacity-70 cursor-pointer top-[40rem] left-[4rem] absolute z-50"
          drag={true}
          dragConstraints={{
            top: -10,
            left: -10,
      ...
      <div className="">
        <motion.img
          className="z-50 w-20 top-[6rem] right-[4rem] absolute cursor-pointer"
          drag={true}
          dragConstraints={{
            top: -10,
            left: -10,
        ...
        />
        <motion.img
          className="z-50 w-20 opacity-70 top-[14rem] right-[15rem] absolute cursor-pointer"
          drag={true}
          dragConstraints={{
            top: -10,
            left: -10,
        ...
        />
        <motion.img
          className="z-50 opacity-70 w-20 top-[28rem] right-[10rem] absolute cursor-pointer"
          drag={true}
          dragConstraints={{
            top: -10,
            left: -10,
        ...
        />
        <motion.img
          className="z-50 opacity-70 w-20 top-[45rem] right-[20rem] absolute cursor-pointer"
          drag={true}
          dragConstraints={{
            top: -10,
            left: -10,
