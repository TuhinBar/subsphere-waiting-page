  ...
  return (
    <div className="flex flex-col gap-4">
      {peoples.map((people, index) => {
        return (
          <div
            className={`bg-gradient-to-t from-[#2D333C] to-[#6A7380] w-24 rounded-md p-2  cursor-pointer transition-all duration-1000 ${
              index === hoveredItem
          ...
          >
            <div
              className={`flex flex-col items-center justify-center  opacity-${
